...
package com.fantomsoftware.bottomsheet;
...
public class BottomSheet extends Dialog implements DialogInterface{
   ...
   private void init( final Context context ){
      ...
      final ClosableSlidingLayout mDialogView = (ClosableSlidingLayout)
         View.inflate( context, R.layout.bottom_sheet_dialog, null );
   ...
   /**
    * Constructor using a context for this builder and the {@link com.fantomsoftware.bottomsheet.BottomSheet} it creates.
    */
   public static class Builder{
      ...
      /**
       * Constructor using a context for this builder and the {@link com.fantomsoftware.bottomsheet.BottomSheet} it creates with given style
       *
       * @param context A Context for built BottomSheet.
