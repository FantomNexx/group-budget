...
>
*/
public class Task_SearchOpsUser extends AsyncTask<Void, Integer, Void>{
   //---------------------------------------------------------------------------
   private String search_str;

   private SparseArray<OperationUser> ops          = null;
   private SparseArray<OperationUser> ops_filtered = null;

   private OnResultSearchOpsUser on_result = null;
   //---------------------------------------------------------------------------


   //---------------------------------------------------------------------------
   public void SetData( String search_str, SparseArray<OperationUser> ops ){
      this.search_str = search_str;
      this.ops = ops;
   }//SetData
   //---------------------------------------------------------------------------
   public void SetOnResult( OnResultSearchOpsUser on_result ){
