...
public class RecycleA_Users
   extends RecyclerView.Adapter<RecycleA_Users.ViewHolder>{
   ...
   //---------------------------------------------------------------------------
   public RecycleA_Users( SparseArray<User> data ){
      this.data = data;
   }//RecycleA_Currencies
   //---------------------------------------------------------------------------
   ...
   //---------------------------------------------------------------------------
   @Override
   public RecycleA_Users.ViewHolder onCreateViewHolder(
